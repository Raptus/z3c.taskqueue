...
class TestIdGenerator(unittest.TestCase):
    ...
    def test_sequence(self):
        self.assertEqual(1392637175, self.service._generateId())
        self.assertEqual(1392637176, self.service._generateId())
        self.assertEqual(1392637177, self.service._generateId())
        self.assertEqual(1392637178, self.service._generateId())

    def test_in_use_randomises(self):
        self.assertEqual(1392637175, self.service._generateId())
        self.service.jobs[1392637176] = object()
        self.assertEqual(1506179619, self.service._generateId())
        self.assertEqual(1506179620, self.service._generateId())
        self.service.jobs[1506179621] = object()
        self.assertEqual(2055242787, self.service._generateId())
