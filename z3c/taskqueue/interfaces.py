...
class ITask(interface.Interface):
    ...
    inputSchema = schema.Object(
        title='Input Schema',
        description='A schema describing the task input signature.',
        schema=interface.Interface,
        required=False)

    outputSchema = schema.Object(
        title='Output Schema',
        description='A schema describing the task output signature.',
        schema=interface.Interface,
        required=False)
...
class IJob(interface.Interface):
    ...
    error = schema.Object(
        title='Error',
        description='The error object when the task failed.',
        schema=interface.Interface,
        required=False,
        default=None)
    ...
    created = schema.Datetime(
        title='Creation Date',
        description='The date/time at which the job was created.',
        required=True)

    started = schema.Datetime(
        title='Start Date',
        description='The date/time at which the job was started.')

    completed = schema.Datetime(
        title='Completion Date',
        description='The date/time at which the job was completed.')
...
class IProcessor(interface.Interface):
    ...
    running = schema.Bool(
        title="Running Flag",
        description="Tells whether the processor is currently running.",
        readonly=True)
